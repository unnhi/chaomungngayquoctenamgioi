...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tình cảm của chúng mình " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Đó là vì :';
document.querySelector('.Description .modal-body').innerHTML = 'Các cậu là những người tuỵt vời đó <i class="fas fa-heart"></i> ';
